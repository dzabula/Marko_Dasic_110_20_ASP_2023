    ...
    public class CreateUserCommand : EfBase, ICreateUserCommand
    {
        ...
        public void Execute(CreateUserDto request)
        {
            ...
            emailSend.Send(new MailDto
            {
                ...
                Message = request.FirstName + " " + request.LastName + " Dobro dosli na ansu platformu, nasi call centar operateri su vam dostupni 24h ukoliko imate bilo kakvih pitanja"
            }); ;
