    ...
    public class CreateCommentValidator : AbstractValidator<CreateCommentDto>
    {
        public CreateCommentValidator(ApartmentContext context)
        {
            ...
            RuleFor(x => x.ParrentId)
                ...
                .Must(x => x == null || context.Comments.Any(y => y.Id == x)).WithMessage("Komentar na koji zelite da odgovorite vise ne postoji")
                .Must(x => x == null || context.Comments.Any(y => y.Id == x && y.ParrentId == null)).WithMessage("Nije moguce odgovoriti na odgovor komentara");
